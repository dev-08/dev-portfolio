...
return (
    <div className=" flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed">
            ...
            <div>
                <h1 className="text-5xl font-signature"> Dev
            ...
            <div className=" cursor-pointer pr-5 z-10 text-gray-500 md:hidden" onClick={handlechange} >
             ...
             from-black to-gray-800 text-gray-500">
              ...
              {links.map((link)=> (
                ...
                className="px-4 cursor-pointer capitalize py-6 text-4xl">
                     <Link onClick={handlechange} to={link.link} smooth duration={500}>{link.link}</Link>
                </li>
              ))}
            </ul>)}
